...
resDir <- here("Results", "SS2_P5_woFilter50k", "01-Seurat")
...
cts1 <- readSCMM(file.path("/srv/gstore/projects/p2497", loc, "P5_1-counts.mtx"))
cts2 <- readSCMM(file.path("/srv/gstore/projects/p2497", loc, "P5_2-counts.mtx"))
