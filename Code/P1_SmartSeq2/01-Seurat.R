...
resDir <- here("Results", "SS2_P1_woFilter50k", "01-Seurat")
...
cts1 <- readSCMM(file.path("/srv/gstore/projects/p2497", loc, "P1_1-counts.mtx"))
cts2 <- readSCMM(file.path("/srv/gstore/projects/p2497", loc, "P1_2-counts.mtx"))
...
mito.genes <- grep(pattern = "^mt-", x = rownames(scData@data), value = TRUE)
