...
resDir <- here("Results", "SS2_P60_BatchCorrection_woFilter50k", "03-Plots4SNATWeb")
dir.create(resDir, recursive = TRUE)

im_size <- 6.945
scData <- readRDS(here("Results", "SS2_P60_BatchCorrection_woFilter50k", "02-Analyses", "scData.rds"))
