...
resDir <- here("Results", "10x_P1", "01-Seurat")
dir.create(resDir, recursive = TRUE)
figNumer <- 1

# Load the gene-cell count
cts <- list()
cts[[1]] <- Read10X(data.dir = "/srv/gstore/projects/p2497/CellRangerCount_27038_2018-07-02--14-14-53/10X_P1_1/outs/filtered_gene_bc_matrices/10X_Ref_Mouse_GRCm38.p5_20180305_Release_91/")
cts[[2]] <- Read10X(data.dir = "/srv/gstore/projects/p2497/CellRangerCount_27038_2018-07-02--14-14-53/10X_P1_2/outs/filtered_gene_bc_matrices/10X_Ref_Mouse_GRCm38.p5_20180305_Release_91/")
cts[[3]] <- Read10X(data.dir = "/srv/gstore/projects/p2497/CellRangerCount_26954_2018-06-04--10-22-27/10X_P1_3/outs/filtered_gene_bc_matrices/10X_Ref_Mouse_GRCm38.p5_20180305_Release_91/")
...
scData <- CreateSeuratObject(raw.data = cts, min.cells = 5, project = "10X_P1")
...
scData <- FindClusters(object = scData, reduction.type = "pca", dims.use = 1:10,
                       resolution = 0.5, print.output = 0, prune.SNN = 0/100,
