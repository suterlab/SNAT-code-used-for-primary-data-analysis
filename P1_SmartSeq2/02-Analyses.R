...
resDir <- here("Results", "SS2_P1_woFilter50k", "02-Analyses")
dir.create(resDir, recursive = TRUE)
figNumer <- 1

# Upgrade Seurat v2 object to v3 object
scData <- readRDS(here("Results", "SS2_P1_woFilter50k", "01-Seurat", "scData.rds"))
scData <- UpdateSeuratObject(scData)
scData <- RenameIdents(scData, "0"="iSC", "1"="pmSC", "2"="prol. SC")
